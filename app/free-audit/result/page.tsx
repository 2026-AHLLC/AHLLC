    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-zinc-950 px-6 text-white">
        <section className="max-w-xl rounded-3xl border border-white/10 bg-zinc-900 p-8 text-center">
          ...
          <Link
            href="/free-audit"
            className="mt-7 inline-flex items-center gap-2 rounded-xl bg-cyan-400 px-6 py-3 font-semibold text-zinc-950"
          >
            Generate audit
  ...
  return (
    <main className="min-h-screen bg-zinc-950 px-6 py-16 text-white lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-8 rounded-3xl border border-cyan-400/20 bg-cyan-400/10 p-8 text-center">
          <h2 className="text-2xl font-bold">Recommended next step</h2>
          <p className="mx-auto mt-4 max-w-3xl leading-8 text-zinc-200">
            {report.nextStep}
          </p>
          <Link
            href="/contact"
